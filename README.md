...
The *_config.yaml* file controls the appearance of the webpage. The about.md file in the *_pages* directory contains the content of the main webpage. The *_pages* is to contain PDFs of papers. The *_talks* is to contain PDFs of talks. The blog posts are in *_posts*. They must be written in markdown.
