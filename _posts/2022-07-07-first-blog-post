---
layout: post
title: "MooersLab launces blog in GitHub Pages"
date: 2022-07-07
---

I finally got around to adding a blog post to the MooersLab GitHub Pages. 
I am able to edit this file directly in Emacs by using atomic-chrome.el package and the Ghost Text Plugin. 
