...
<p>Note that tree-sitter is available on Anaconda as `tree_sitter` (note the underscore) and can be installed wherever you have permission to install conda packages, including some remote servers.  <br />
